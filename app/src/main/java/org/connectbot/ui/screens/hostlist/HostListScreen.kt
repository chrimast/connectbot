...
fun HostListScreen(
    ...
    onNavigateToPresetScripts: () -> Unit = {},
    ...
    HostListScreenContent(
        ...
        onNavigateToPresetScripts = onNavigateToPresetScripts,
                ...
                actions = {
                    if (!makingShortcut) {
                        ...
                        DropdownMenu(
                            ...
                            DropdownMenuItem(
                                text = { Text(stringResource(R.string.list_menu_preset_scripts)) },
                                onClick = {
                                    showMenu = false
